- [Python设计模式](#python设计模式)
  ...
  * [2. 设计模式的六大原则](#2-设计模式的六大原则)
    + [2.1 开闭原则（Open Close Principle）](#21-开闭原则Open-Close-Principle)
    + [2.2 里氏代换原则（Liskov Substitution Principle）](#22-里氏代换原则Liskov-Substitution-Principle)
    + [2.3 依赖倒转原则（Dependence Inversion Principle）](#23-依赖倒转原则Dependence-Inversion-Principle)
    + [2.4 接口隔离原则（Interface Segregation Principle）](#24-接口隔离原则Interface-Segregation-Principle)
    + [2.5 迪米特法则，又称最少知道原则（Demeter Principle）](#25-迪米特法则又称最少知道原则Demeter-Principle)
    + [2.6 合成复用原则（Composite Reuse Principle）](#26-合成复用原则（Composite-Reuse-Principle)
  * [3. 设计模式的分类](#3-设计模式的分类)
    + [3.1 创建型模式（Creational Patterns）](#31-创建型模式creational-patterns)
      - [3.1.1 工厂模式（Factory Pattern）](#311-工厂模式factory-pattern)
      - [3.1.2 工厂方法模式（Factory Method Pattern）](#312-工厂方法模式factory-method-pattern)
      - [3.1.3 抽象工厂模式（Abstract Factory Pattern）](#313-抽象工厂模式abstract-factory-pattern)
      - [3.1.4 单例模式（Singleton Pattern）](#314-单例模式singleton-pattern)
      - [3.1.5 建造者模式（Builder Pattern）](#315-建造者模式builder-pattern)
      - [3.1.6 原型模式（Prototype Pattern）](#316-原型模式prototype-pattern)
    + [3.2 结构型模式（Structural Patterns）](#32-结构型模式structural-patterns)
      - [3.2.1 适配器模式（Adapter Pattern）](#321-适配器模式adapter-pattern)
      - [3.2.2 桥接模式（Bridge Pattern）](#322-桥接模式bridge-pattern)
      - [3.2.3 组合模式（Composite Pattern）](#323-组合模式composite-pattern)
      - [3.2.4 外观模式（Facade Pattern）](#324-外观模式facade-pattern)
      - [3.2.5 代理模式（Proxy Pattern）](#325-代理模式proxy-pattern)
      - [3.2.6 过滤器模式（Filter、Criteria Pattern）](#326-过滤器模式filter-criteria-pattern)
      - [3.2.7 装饰器模式（Decorator Pattern）](#327-装饰器模式decorator-pattern)
      - [3.2.8 享元模式（Flyweight Pattern）](#328-享元模式flyweight-pattern)
    + [3.3 行为型模式（Behavioral Patterns）](#33-行为型模式behavioral-patterns)
      - [3.3.1 责任链模式（Chain of Responsibility Pattern）](#331-责任链模式chain-of-responsibility-pattern)
      - [3.3.2 策略模式（Strategy Pattern）](#332-策略模式strategy-pattern)
      - [3.3.3 模板模式（Template Pattern）](#333-模板模式template-pattern)
      - [3.3.4 观察者模式（Observer Pattern）](#334-观察者模式observer-pattern)
      - [3.3.5 命令模式（Command Pattern）](#335-命令模式command-pattern)
      - [3.3.6 解释器模式（Interpreter Pattern）](#336-解释器模式interpreter-pattern)
      - [3.3.7 迭代器模式（Iterator Pattern）](#337-迭代器模式iterator-pattern)
      - [3.3.8 中介者模式（Mediator Pattern）](#338-中介者模式mediator-pattern)
      - [3.3.9 备忘录模式（Memento Pattern）](#339-备忘录模式memento-pattern)
      - [3.3.10 状态模式（State Pattern）](#3310-状态模式state-pattern)
      - [3.3.11 空对象模式（Null Object Pattern）](#3311-空对象模式null-object-pattern)
      - [3.3.12 访问者模式（Visitor Pattern）](#3312-访问者模式visitor-pattern)
